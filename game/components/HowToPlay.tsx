...
import {
    BIG_ARMY, BRIDGE_CREW_CAP, CAP_ENEMY_T, CAP_NEUTRAL_T, CROWD_LIMIT, MAX_BUILT_BRIDGES, MELEE_CAP, PRESTIGE_WIN, SPEED_SWIM, SURRENDER_FRAC, TIME_LIMIT, FLAG_ISOLATE_T, FLAG_VISION_R, DEPOT_CAP_T, DEPOT_EXPIRE_T, DEPOT_VALUE
} from "@game/shared";
                ...
                <div className="overflow-y-auto pr-1 text-[13px] leading-relaxed">
                    ...
                    {tab === "Uy thế" && (
                        <>
                            ...
                            <H>Nguồn Uy thế</H>
                            <Ul>
                                <li><b>Cứ điểm sông (Đầu cầu)</b>: chiếm cứ điểm sông <b>KHÔNG</b> cộng Uy thế nữa. Chúng đóng vai trò là "Đầu cầu" tiếp tế.</li>
                                <li><b>Cờ trên đất địch</b>: +1/s mỗi cờ. <b>Điều kiện:</b> Phe bạn phải đang giữ ít nhất 1 Đầu cầu (cứ điểm sông HOẶC cầu tự xây đã xây xong). Nếu mất toàn bộ đầu cầu, cờ sẽ bị cô lập (không cho điểm) và tự trả về cho địch sau {FLAG_ISOLATE_T}s. Cờ nhà của mình không cho điểm — chỉ cho tầm nhìn {FLAG_VISION_R} ô và tự động hồi máu cho quân.</li>
                                <li><b>Kho lương</b>: Xuất hiện vào phút 5, 9, 13, 17. Đứng chiếm kho trong {DEPOT_CAP_T}s nhận ngay +{DEPOT_VALUE} Uy thế. Kho biến mất sau {DEPOT_EXPIRE_T / 60} phút.</li>
                                <li><b>Phá công trình địch</b>: Tu viện / Trường bắn / Trại lính +40, Tháp +25, Nhà +10. (Lưu ý: Không giữ Cầu giữa thì sát thương vào công trình chỉ còn 25%).</li>
                    ...
                    {tab === "Mẹo" && (
                        <Ul>
                            ...
                            <li>Phải bảo vệ <b>Đầu cầu</b> (Cứ điểm sông hoặc Cầu tự xây)! Nếu địch cắm cờ trong đất bạn, hãy phá/chiếm lại mọi Đầu cầu của địch để cắt tiếp tế, cờ sẽ bị cô lập và tự trả về sau {FLAG_ISOLATE_T}s.</li>
                            <li>Bắc cầu phụ để tạo Đầu cầu mới, hoặc dùng để đánh vòng ra sau lưng địch cướp Kho lương.</li>
